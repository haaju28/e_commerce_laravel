...
@section('content')
	...
	<!-- Shoping Cart -->
	<form class="bg0 p-t-75 p-b-85" action="{{route('checkout.place-order')}}" method="POST">
			...
			<div class="row">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<input disabled class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="name" placeholder="Name" value="{{Auth::user()->name}}">
									</div>
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="email" id="email" name="email" placeholder="Email" value="">
										@error('email')
											<span class="text-danger">{{$message}}</span>
										@enderror
									</div>
									...
									<div class="bor8 bg0 m-b-12">
										<input  class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" id="phone" name="phone" placeholder="Phone" value="">
										@error('phone')
											<span class="text-danger">{{$message}}</span>
										@enderror
									</div>
									...
									<div class="bor8 bg0 m-b-22">
										<input  class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" id="address" name="address" placeholder="Address" value="">
										@error('address')
											<span class="text-danger">{{$message}}</span>
										@enderror
									</div>
									...
									<div class="flex-w">
										<a class="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer" href="{{route('shop')}}">
											Update Cart
										</a>
									</div>
						...
						@if ($total===0)
							<a class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" href="{{route('shop')}}">
								Go to shop
							</a>
						@else
							<button id="place_order_btn" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
								PLACE ORDER
							</button>							
						@endif
