        ...
        <div class="wrap-slick1">
            <div class="slick1">
                @foreach ($banners as $banner)
                    @if ($banner->status)
                        <div class="item-slick1" style="background-image: url({{asset("images/$banner->image")}});">
                            ...
                            <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{asset("images/$newProduct->image_url")}}" alt="{{$newProduct->name}}">

                                        <a href="{{ route('product.detail', ['slug' => $newProduct->slug]) }}"  class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                            View detail
                                        </a>
                                    </div>
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            <a href="{{ route('product.detail', ['slug' => $newProduct->slug]) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                                {{$newProduct->name}}
                                            </a>

                                            <span class="stext-105 cl3">
                                                {{number_format($newProduct->price, 0, ',', '.') }} vnd
                                            </span>
                                        </div>
                                        ...
                                        <div class="block2-txt-child2 flex-r p-t-3">
                                            ...
                                            @if (auth()->check())
                                                ...
                                                @if($wishlist)
                                                    <form method="POST" action="{{ route('wishlist.destroy', $newProduct->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                @else
                                                    <a href="{{ route('wishlist.add', $newProduct->id) }}" class="addToCartButtonContainer btn-addwish-b2 dis-block pos-relative">
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($blogs as $blog)
                    @if ($blog->status && $blog->is_approved)
                        <div class="col-sm-6 col-md-4 p-b-40">
                            <div class="blog-item">
                                ...
                                <div class="p-t-15">
                                    ...
                                    <h4 class="p-b-12">
                                        <a href="{{ route('blog.detail', ['slug' => $blog->slug]) }}" class="mtext-101 cl2 hov-cl1 trans-04">
                                            {{$blog->title}}
                                        </a>
                                    </h4>
