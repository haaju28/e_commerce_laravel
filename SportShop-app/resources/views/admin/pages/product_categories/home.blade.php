                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <button class="btn btn-primary"><a class="text-light" href="{{url('admin/product-category/create')}}">Add category</a></button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ( $productCategories as $productCategory )
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $productCategory->trend }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <form method="POST" action="{{ route('product-category.destroy' ,[$productCategory->id])}}">
                                                            @csrf
                                                            @if (!$productCategory->trashed())
                                                                <a class="btn btn-primary" href="{{ route('product-category.edit',[$productCategory->id]) }}">Detail</a>
                                                            @endif
                                                            @method('DELETE')
                                                            @if (!$productCategory->trashed())
                                                        ...
                                                        @if ($productCategory->trashed())
                                                            <form method="POST" action="{{ route('product-category.restore', [$productCategory->id] )}}">
                                                                @csrf
