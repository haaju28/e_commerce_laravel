                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <button class="btn btn-primary"><a class="text-light" href="{{url('admin/blog/create')}}">Add blog</a></button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <table id="example1"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1"
                                                    rowspan="1" colspan="1"
                                                    aria-label="CSS grade: activate to sort column ascending">Approve</th>
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1"
                                                    rowspan="1" colspan="1"
                                            ...
                                            @foreach ( $blogs as $blog )
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <img height="100px" width="200px" src="{{asset("images/$blog->image")}}" alt="{{$blog->title}}">
                                                    </td>
                                                    <td class="text-center">{{ $blog->author }}</td>
                                                    <td class="text-center">{{ \Carbon\Carbon::parse($blog->created_at)->format('d/m/Y')}}</td>
                                                    <td class="text-center">{{ $blog->article_categories_name }}</td>
                                                    @if ($blog->is_approved)
                                                    ...
                                                    <td class="text-center d-flex justify-content-center align-item-center">
                                                        <form method="POST" action="{{ route('blog.destroy' ,[$blog->id])}}">
                                                            @csrf
                                                            <a class="btn btn-primary" href="{{ route('blog.edit',[$blog->id]) }}">Detail</a>
                                                            @method('DELETE')
