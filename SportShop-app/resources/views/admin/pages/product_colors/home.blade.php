                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <button class="btn btn-primary"><a class="text-light" href="{{url('admin/color/create')}}">Add color</a></button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ( $colors as $color )
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $color->slug }}</td>
                                                    @if ($color->status)
                                                    ...
                                                    <td class="text-center">
                                                        <form method="POST" action="{{ route('color.destroy' ,[$color->id])}}">
                                                            @csrf
                                                            @if (!$color->trashed())
                                                                <a class="btn btn-primary" href="{{ route('color.edit',[$color->id]) }}">Detail</a>
                                                            @endif
                                                        ...
                                                        @if ($color->trashed())
                                                            <form method="POST" action="{{ route('color.restore', [$color->id] )}}">
                                                                @csrf
